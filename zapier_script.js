...
//MD5 hashing used for generating secret
...
const provinces = {"- Select -":"","Alberta":"AB","British Columbia":"BC","Manitoba":"MB","New Brunswick":"NB","Newfondland and Labrador":"NL","Northwest Territories":"NT","Nova Scotia":"NS","Nunavut":"NU","Ontario":"ON","Prince Edward Island":"PE","Quebec":"QC","Saskatchewan":"SK","Yukon":"YT"}; 
...
if (provinces.hasOwnProperty(inputData.administrative_area)){
        adminareaCode = provinces[inputData.administrative_area];
}
